# 1. Make a copy of this file and re-name it to `UNFINISHED_data_dir.py`
...
#
# NOTE: the `UNFINISHED_data_dir.py` file will be automatically gitignored so as to not overwrite the ones
