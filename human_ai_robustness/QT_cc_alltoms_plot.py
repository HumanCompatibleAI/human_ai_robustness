...
"""
Here we take data for the X agents on Y playing the set of qualitative tests. We then do the following plotting:
    • Data:
        ◦ Should be A agents, with B seeds each
        ◦ Ignore test 2
    • Plot 1:
        ◦ Avg over seeds
